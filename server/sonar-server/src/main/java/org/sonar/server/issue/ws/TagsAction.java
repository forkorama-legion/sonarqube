...
public class TagsAction implements IssuesWsAction {
  ...
  private List<String> listTags(OrganizationDto organization, @Nullable String textQuery, int pageSize) {
    Collection<String> issueTags = issueIndex.listTags(organization.getUuid(), textQuery, pageSize);
    Collection<String> ruleTags = ruleIndex.listTags(organization.getUuid(), textQuery, pageSize);
